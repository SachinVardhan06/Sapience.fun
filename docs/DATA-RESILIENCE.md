...
**API host:** run GraphQL at **`https://api.sapience.fun/`** (DNS `api` → your Node host). The React app on **`https://app.sapience.fun`** calls it via `VITE_GQL_URL` (see `.env.example`).
